<template>
  ...
  <div style='text-align: center; margin-top: 1ex; margin-bottom: 4ex'>
    ...
    <span class='qwq'>
      <a target='_blank' href='https://github.com/kawa-yoiko/THSSBBS'>
        <i class='code icon'></i> Source</a>
    </span>
    <br>
    <span class='qwq'>Dual licensed under
      <a target='_blank' href='https://www.gnu.org/licenses/agpl-3.0.html'>GNU AGPLv3</a>
      and
      <a target='_blank' href='https://firstdonoharm.dev/version/2/1/license.html'>
